...
public class StudentService : IStudentService
{
    ...
    private async Task<string?> BuildCvAnalysisJsonAsync(Stream pdfStream)
    {
        ...
        var systemPrompt = @"Sen bir insan kaynakları veri çıkarma asistanısın. Görevin, verilen CV metnini analiz edip aşağıdaki JSON şemasına TITIZLIKLE uygun şekilde veri çıkarmaktır. SADECE JSON formatında cevap ver, fazladan bir şey yazma. Eğer bir alan bulunamazsa boş bırak: string için """", liste için [].
JSON Şeması:
{
